...
#define CUSTOM_MACHINE_NAME "Hello Alex"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,  100, 400, 94.3709}
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.29   // Z offset: -below +above  [the nozzle]
